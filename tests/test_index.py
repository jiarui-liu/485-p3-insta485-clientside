...
def test_feed_load(live_server, driver):
    ...
    assert driver.find_elements(By.XPATH, "//a[@href='/users/awdeorio/']")
    assert driver.find_elements(By.XPATH, "//a[@href='/users/jflinn/']")
    assert driver.find_elements(By.XPATH, "//a[@href='/users/michjc/']")
    ...
    assert driver.find_elements(
        By.XPATH,
        "//*[contains(normalize-space(.), 'I <3 chickens')]"
    )
    assert driver.find_elements(
        By.XPATH,
...
def test_like_unlike(live_server, driver):
    ...
    assert driver.find_elements(
        By.XPATH,
        "//*[contains(normalize-space(.), '0 likes')]")
